...
export function RegisterRoutes(app: express.Router) {
    ...
    // ###########################################################################################################
        ...
        app.get('/api/v1/admins/:adminId',
            authenticateMiddleware([{"bearerAuth":[]}]),
            function AdminController_getById(request: any, response: any, next: any) {
            const args = {
        ...
        app.delete('/api/v1/admins/:adminId',
            authenticateMiddleware([{"bearerAuth":[]}]),
            function AdminController_delete(request: any, response: any, next: any) {
            const args = {
                    adminId: {"in":"path","name":"adminId","required":true,"dataType":"string"},
            };
        ...
        app.get('/api/v1/auth/confirm-mail/:activationLink',
            function AuthController_confirmMail(request: any, response: any, next: any) {
            const args = {
            ...
            const promise = controller.confirmMail.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, undefined, next);
        });
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
