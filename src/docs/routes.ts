...
const models: TsoaRoute.Models = {
    ...
    "UpdatePasswordDto": {
        "dataType": "refObject",
        "properties": {
            "passwordCurrent": {"dataType":"string","required":true},
            "password": {"dataType":"string","required":true},
            "passwordConfirm": {"dataType":"string","required":true},
        },
        "additionalProperties": false,
    ...
    "IAdmin": {
        ...
        "properties": {
            ...
            "password": {"dataType":"string","required":true},
            "activationLink": {"dataType":"string","required":true},
            "passwordResetToken": {"dataType":"string","required":true},
            "passwordResetExpires": {"dataType":"datetime","required":true},
...
export function RegisterRoutes(app: Router) {
    ...
    // ###########################################################################################################
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/api/v1/auth/confirm-mail/:activationLink',
            ...(fetchMiddlewares<RequestHandler>(AuthController)),
            ...(fetchMiddlewares<RequestHandler>(AuthController.prototype.confirmMail)),

            async function AuthController_confirmMail(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    activationLink: {"in":"path","name":"activationLink","required":true,"dataType":"string"},
            };
        ...
        app.post('/api/v1/auth/forgot-password',
            ...
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    forgotPasswordDto: {"in":"body","name":"forgotPasswordDto","required":true,"ref":"ForgotPasswordDto"},
                    req: {"in":"request","name":"req","required":true,"dataType":"object"},
            };
        ...
        app.post('/api/v1/auth/update-password',
            ...
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    updatePasswordDto: {"in":"body","name":"updatePasswordDto","required":true,"ref":"UpdatePasswordDto"},
                    req: {"in":"request","name":"req","required":true,"dataType":"object"},
            };
        ...
        app.get('/api/v1/admins',
            ...
            async function AdminController_getAll(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.get('/api/v1/admins/:adminId',
            authenticateMiddleware([{"bearerAuth":[]}]),
            ...(fetchMiddlewares<RequestHandler>(AdminController)),
            ...(fetchMiddlewares<RequestHandler>(AdminController.prototype.getById)),

            async function AdminController_getById(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.patch('/api/v1/admins/:adminId',
            authenticateMiddleware([{"bearerAuth":[]}]),
            ...(fetchMiddlewares<RequestHandler>(AdminController)),
            ...
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    adminId: {"in":"path","name":"adminId","required":true,"dataType":"string"},
                    updateAdminDto: {"in":"body","name":"updateAdminDto","required":true,"ref":"UpdateAdminDto"},
            };
        ...
        // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
        app.delete('/api/v1/admins/:adminId',
            authenticateMiddleware([{"bearerAuth":[]}]),
            ...(fetchMiddlewares<RequestHandler>(AdminController)),
            ...(fetchMiddlewares<RequestHandler>(AdminController.prototype.delete)),

            async function AdminController_delete(request: ExRequest, response: ExResponse, next: any) {
            const args: Record<string, TsoaRoute.ParameterSchema> = {
                    adminId: {"in":"path","name":"adminId","required":true,"dataType":"string"},
            };
